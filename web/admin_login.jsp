...
<body>
	...
	<form method="POST" action="ad_log.jsp">
	
	<br>
        <center><h1><b>ADMIN</b></h1></center>
	<br><br>
	<font size="5px">Username</font>
        <input required="required" class="form-control" placeholder="Enter Username" type="text" name="username"/>
	<br>
	<font size="5px">Password</font>
        <input required="required" class="form-control" type="password" placeholder="Enter Password" name="password"/>
	<br><br><br>
        <center> <input class="btn btn-primary" type="submit" name="submit" value="Login"/></center>
