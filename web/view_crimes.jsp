        ...
        <form method="POST" action="">
            <center>
                ...
                <table class="table table-striped">
                    ...
                    <%                        rs = st.executeQuery("select * from crime where assigned='" + user + "' and status!='Fraud'");
                        while (rs.next()) {
                    %>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info" href="view_crime.jsp?id=<%= rs.getString("id")%>">View Report</a></td><td>

                            <a class="btn btn-primary" href="fraud?user=<%= rs.getString("victum")%>&id=<%= rs.getString("id")%>">Fraud Reports</a>
