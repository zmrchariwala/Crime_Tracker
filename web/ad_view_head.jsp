...
<body>
    ...
    <form method="POST" action="">
        <center> <h1>HEAD OFFICE</h1> </center>
        ...
        <%
            rs=st.executeQuery("select * from head_office where city='"+request.getParameter("district")+"'");
            while(rs.next())
            {
            %>
            <tr>
                ...
                <td>
                    <a class="btn btn-info" href="update_headoffice.jsp?id=<%= rs.getString("id") %>">Update</a>
                </td>
            </tr>
            <%
                }
