...
<body>
    ...
    <%
        ...
        rs=st.executeQuery("select * from head_office where id="+id);
        if(rs.next())
        {
        %>
        
	<form method="POST" action="updatehead">
	<center>
            <input type="hidden" name="id" value="<%= id %>"/>
	<br>
	<h1><b>UPDATE HEAD OFFICE</b></h1>
	<br><br>
	<table>
	...
	<td style="height:40px;"><font size="5px">City</font></td>
        <td><select class="form-control" id="city" name="city">
