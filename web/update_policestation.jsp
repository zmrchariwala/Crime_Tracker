...
<body>
    <script type="text/javascript">
		...
		xreq.onreadystatechange = function(){
			if((xreq.readyState==4)&&(xreq.status==200)){
				document.getElementById("dist").innerHTML = xreq.responseText;
			}
		}
	}   
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="ad_view_crime.jsp">View Crimes</a></li>
    ...
    <%
        ...
        rs=st.executeQuery("select * from police_station where id="+id);
        if(rs.next())
        {
        %>
	<form method="POST" action="update_police">
	<center>
            <input type="hidden" name="id" value="<%= id  %>"/>
	<br>
	<h1><b>UPDATE POLICE STATION</b></h1>
	<br><br>
	<table>
	<tr><td style="height:40px;">
	<font size="5px">Incharge Officer</font></td><td>
                <input class="form-control" type="text" value="<%= rs.getString("incharge_officer") %>" name="officer"/></td></tr>
        <tr><td style="height:40px;">
	<font size="5px">Position</font></td><td>
	<input class="form-control" type="text" value="<%= rs.getString("position") %>" name="post"/></td></tr>
	...
	<td style="height:40px;"><font size="5px">District</font></td>
        <td><select class="form-control" name="dist" id="dist" onchange=getCity(this.value)>
	...
	<input class="form-control" type="text" value="<%= rs.getString("email") %>" name="email"/></td></tr>
	<tr><td style="height:40px;">
	<font size="5px">Enter Username</font></td><td>
	<input class="form-control" type="text" value="<%= rs.getString("username") %>" name="username" readonly></td></tr>
	
            <%
                }
                %>
                <tr><td>
            <input class="btn btn-primary" type="submit" name="submit" value="Update"/><td></tr>
	</table>
	</center>
